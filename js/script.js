...
function createCategoryItem(categoryKey, category, isLocked = false) {
    ...
    switch(categoryKey) {
        ...
        case 'population':
            ...
            break;
        case 'area':
            iconContent = '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M3,5v15h16v2H3c-1.1,0-2-0.9-2-2V5H3z M21,1H7C5.9,1,5,1.9,5,3v11c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V3 C23,1.9,22.1,1,21,1z M21,14H7V3h14V14z M17,5h-2v2h2V5z M13,5h-2v2h2V5z M9,5H7v2h2V5z M17,9h-2v2h2V9z M13,9h-2v2h2V9z M9,9H7v2h2 V9z"/></svg>';
            break;
        default:
