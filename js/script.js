...
function createCategoryItem(categoryKey, category, isLocked = false) {
    ...
    switch(categoryKey) {
        ...
        case 'population':
            ...
            break;
        case 'area':
            iconContent = '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M17,15H19V17H17V15M19,11H21V13H19V11M15,15H17V17H15V15M19,7H21V9H19V7M19,3H21V5H19V3M15,11H17V13H15V11M15,7H17V9H15V7M15,3H17V5H15V3M11,15H13V17H11V15M11,11H13V13H11V11M11,7H13V9H11V7M11,3H13V5H11V3M7,15H9V17H7V15M7,11H9V13H7V11M7,7H9V9H7V7M7,3H9V5H7V3H21V21H3V3H7Z"/></svg>';
            break;
        default:
